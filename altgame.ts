...
let totalsei:number = 0;　//総合正解数
let totalhusei:number = 0;　//総合不正解数
let totalsyutudai:number = 0;　//総合出題数
...
const scorenode:HTMLUListElement = <HTMLUListElement>document.getElementById("scorerail"); 
...
const navmessage:HTMLSpanElement = <HTMLSpanElement>document.getElementById("navigate");
